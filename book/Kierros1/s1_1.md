...
```
Kun oppimateriaalissa näytetään, mitä input-funktiolle annetaan syötteenä, käytetään ":"-merkkiä. Ylempi esimerkki syötteessä: (voit myös kokeilla Spyderissä kopioimalla ylläolevan koodin)
