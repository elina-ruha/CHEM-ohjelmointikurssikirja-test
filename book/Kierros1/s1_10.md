...
Toinen esimerkki, jossa pyydetään käyttäjältä kokonaislukuja, kunnes käyttäjä antaa "*" ja sitten lasketaan 
...
### Tehtävä 1.10.1
Täydennä allaoleva ohjelma niin, että se tekee enintään kymmenen mittausta ja lopettaa arvojen kysymisen, jos mittauksien
summa ylittää 100 g. Tehtävässä käyttäjä antaa ensimmäisellä kerralla massaksi 3.6583 g (joka on tallennettu jo etukäteen 
