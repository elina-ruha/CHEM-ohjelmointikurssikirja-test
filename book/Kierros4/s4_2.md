...
matriisi = np.array([[10, 20, 30],
                     [40, 50, 60]])
ekan_rivin_eka_sarake = matriisi[0, 0] # 10
tokan_rivin_toka_sarake = matriisi[1, 1] # 50
tokan_rivin_vika_sarake = matriisi[1, -1] # 60
print(ekan_rivin_eka_sarake)
print(tokan_rivin_toka_sarake)
print(tokan_rivin_vika_sarake)
```
:::{admonition} Huom!
:class: note
...
print(vektorin_pituus)
T_kolmas_ulottuvuus_pituus = len(T[0, 0])
print(T_kolmas_ulottuvuus_pituus)
```
...
:::{admonition} Huom!
:class: attention
Huomaa, etta oletuksena *stop*-luku tulee mukaan, toisin kuin *arange*-funktiossa!
:::
```{code-cell} ipython3
