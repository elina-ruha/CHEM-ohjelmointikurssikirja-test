...
```
Jos kaikki menee hyvin, ohjelmaa tulostaa saman kuin ylläolevan koodin ajaessa tulostuu.
...
**try-finally** -rakennetta. Helpoiten tämän vaatimuksen voi kuitata käyttämällä **with**-lausetta (ks. seuraava luku).
...
:::
### Tehtävä 5.4.1
tulokset.txt on tiedosto, joka sisältää reaktiotuotteen konsentraatiot viiden minuutin välein. Tiedoston kolme ensimmäistä riviä
voisivat näyttää esimerkiksi tältä:\
1.23\
1.32\
1.44\
