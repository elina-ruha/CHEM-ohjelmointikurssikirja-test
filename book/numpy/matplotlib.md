...
Kun teet Matplotlib-tehtäviä Spyderissä, kuvaajien pitäisi aueta siististi suoraan IPython-konsolin yllä olevalle Plots-välilehdelle. Asiasta kerrotaan lisää [Spyderin käyttöohjeissa](../lisamateriaali/spyder-kaytto.md). 
