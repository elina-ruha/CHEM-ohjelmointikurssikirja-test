...
Yhtälöryhmän yllä oleva yleinen muoto voidaan kirjoittaa myös vektorimuodossa
...
**A** on siis neliömatriisi, **x** ja **b** vektoreita. Nyt kun yhtälöryhmä on saatu matriisimuotoon, sen ratkaisemisessa voidaan hyödyntää lineaarialgebraa. Emme käsittelle teoriaa tämän enempää vaan toteamme vain, että kun meillä on yhtälöryhmä matriisimuodossa **Ax**=**b**, voimme ratkaista sen *scipy.linalg.solve*-funktiolla näin helposti:
``` ipython3
